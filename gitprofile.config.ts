...
const CONFIG = {
  github: {
    username: 'Eperez05', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    ...
    external: {
      ...
      projects: [
        {
          title: 'Ecology Presentation on Knights Ferry',
          description:
  ...
  seo: {
    title: 'Portfolio of Emily Perez',
    description: '',
    imageURL: '',
  },
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://eperez05.github.io',
    phone: '(209)422-1068',
    email: 'emilyp081905@gmail.com',
  },
  resume: {
    fileUrl:
      'https://github.com/Eperez05/Eperez05.github.io/raw/main/Curriculum_Vitae_May2026.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Excel',
    'Microscopy',
